        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Data Kesejahteraan Masyarakat</h3>
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-striped" id="kesraTable">
                    ...
                    <div id="bidangUrusanSection" class="mt-4">
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            <h4>Bidang Urusan - <span id="selectedUrusanName">Kesehatan Masyarakat</span></h4>
                    ...
                    <div id="programSection" class="mt-4">
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            <h4>Program - <span id="selectedBidangUrusanName">Pelayanan Kesehatan</span></h4>
                            ...
                            <table class="table table-bordered table-striped" id="programTable">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>1.1</td>
                                        <td>2024</td>
                                        <td>Program Pelayanan Kesehatan Dasar</td>
                                        <td>Ya</td>
                                        <td>
                    ...
                    <div id="programIndikatorSection" class="mt-4">
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            <h4>Indikator Program - <span id="selectedProgramName">Program Pelayanan Kesehatan Dasar</span></h4>
                            ...
                            <table class="table table-bordered table-striped" id="programIndikatorTable">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>1.1.1</td>
                                        <td>2024</td>
                                        <td>Persentase layanan kesehatan dasar</td>
                                        <td>Ya</td>
                                        <td>
