        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    @include('admin.master.nav_tab_rkp')

                    <div class="tab-content mt-3" id="myTabContent">
                        <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">

                            <div class="d-flex align-items-center">
                                <label class="me-2 fw-bold mb-2">Pilih Tahun</label>
                                <select name="tahun" class="form-select me-2 mb-2" style="width: auto;">
                                    @foreach ($tahun_dropdown as $key => $value)
