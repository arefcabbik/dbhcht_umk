...
@section('title', 'Master Data - Penegakan Hukum')
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Data Penegakan Hukum</h3>
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-striped" id="hukumTable">
                    ...
                    <div id="bidangUrusanSection" class="mt-4">
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            <h4>Bidang Urusan - <span id="selectedUrusanName">Penegakan Hukum</span></h4>
                            ...
                            <table class="table table-bordered table-striped" id="bidangUrusanTable">
                                ...
                                <tbody>
                                    <tr>
                                        <td>2.1</td>
                                        <td>2</td>
                                        <td>Pengawasan dan Penindakan</td>
                                        <td>Ya</td>
                                        <td>
                    ...
                    <div id="programSection" class="mt-4">
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            <h4>Program - <span id="selectedBidangUrusanName">Pengawasan dan Penindakan</span></h4>
                            ...
                            <table class="table table-bordered table-striped" id="programTable">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>2.1</td>
                                        <td>2024</td>
                                        <td>Program Pengawasan Peredaran Rokok Ilegal</td>
                                        <td>Ya</td>
                                        <td>
                    ...
                    <div id="programIndikatorSection" class="mt-4">
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            <h4>Indikator Program - <span id="selectedProgramName">Program Pengawasan Peredaran Rokok Ilegal</span></h4>
                            ...
                            <table class="table table-bordered table-striped" id="programIndikatorTable">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>2.1.1</td>
                                        <td>2024</td>
                                        <td>Persentase penurunan peredaran rokok ilegal</td>
                                        <td>Ya</td>
                                        <td>
...
<script>
    ...
    function viewBidangUrusan(urusanId) {
        ...
        $('#selectedUrusanName').text('Penegakan Hukum');
    ...
    function viewProgram(bidangUrusanId) {
        $('#programSection').show();
        $('#programIndikatorSection').hide();
        $('#selectedBidangUrusanName').text('Pengawasan dan Penindakan');
    ...
    function viewProgramIndikator(programId) {
        ...
        $('#selectedProgramName').text('Program Pengawasan Peredaran Rokok Ilegal');
